...
var testEvent = {
    ResourceProperties: {
        ...
        Username: "macinna",
        Password: "M4sterpass",
        AuthRoleName: "Cognito_KinesisDataGeneratorUsersAuth_Role",
        AuthRoleArn: "arn:aws:iam::765643008125:role/Cognito_KinesisDataGeneratorUsersAuth_Role",
        UnauthRoleName: "Cognito_KinesisDataGeneratorUsersUnauth_Role",
        UnauthRoleArn: "arn:aws:iam::765643008125:role/Cognito_KinesisDataGeneratorUsersUnauth_Role",
        HtmlS3Ref: ""
    }
};

//createPoolAndUser(testEvent, null);
