# https://github.com/awslabs/aws-config-engine-for-compliance-as-code/blob/master/rulesets-build/deploy_rule_templates.py
import sys
import json
import re
import time
...
for region in all_region_list:
    ...
    for s3_object in contents:
        ...
        if not re.match(r'^[0-9]{12}\.json$', key):
            #Skip this one
            print("Skipping " + key)
            continue
